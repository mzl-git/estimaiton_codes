...
%theta1=0.2*pi;theta2=0.1*pi;theta3=0;theta4=0.25*pi;theta5=0.05*pi;
...
for snr=SNR1:step:SNR2
    ...
    for num_of_runs=1:100
        ...
        x=s+Z;
        %%
        wfrealCTsubmf=proposed_real(N,x,L);%frealCTsubmf  frealCTsubim2
        %%
...
hold on
plot(xs,10.*log10(mse_frealCTsubmf),'mp-');
axis([-2 70 -144 -20]) 
legend('CRLB','Proposed','Location','southwest');%
%axis([0 65 -140 -20]) 
