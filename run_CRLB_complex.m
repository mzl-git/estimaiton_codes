...
f1=0.05;f2=0.13;f3=0.26;f4=0.34;f5=0.44;%w2=pi*0.223;
L=5;
n=0:N-1; 
...
for snr=SNR1:step:SNR2
    ...
    for num_of_runs=1:100
        ...
        x=s+Z;
        %%
        wfrealCTsubmf=proposed_complex(N,x,L);
        %%
...
hold on
plot(xs,10.*log10(mse_frealCTsubmf),'m.-');
legend('CRLB','Proposed','Location','southwest');%'2017SEA·¨','¸´ÐÅºÅCRLB','Nuttall windowing',
